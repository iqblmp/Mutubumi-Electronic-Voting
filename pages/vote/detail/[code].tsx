...
export default function DetailOrEditVotes() {
    ...
    return (
        <div>
            <Head>
                <title>Mutubumi - {vote?.title}</title>
            </Head>

            <div className="container mx-auto py-10">
                <Image src={"/images/vote.png"} alt="vote" width={200} height={200} objectFit="contain" />
                ...
                <form className="flex flex-col">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="flex flex-col">
                            ...
                            <Form onChange={setTitle} value={title} placeholder="Contoh : Voting Calon Kepala Sekolah" className="w-1/2" />
                        </div>
                    ...
                    <div className="bg-zinc-100 p-5">
                        ...
                        <p>
                            ...
                            <a href={`/participant/${vote?.code}`} target="_blank" rel="noreferrer noopener" className="text-blue-500">
                                Buka Link
                            </a>
                        </p>
                    </div>
